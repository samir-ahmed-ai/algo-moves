...
import { Btn, Chip, difficultyTone } from '../canvas/nodeui';
import {
  CanvasFrameProvider,
  CanvasStaticProvider,
  useCanvasStatic,
} from '../canvas/CanvasContext';
import { ProblemPanelBody } from '../canvas/panels/ProblemPanelBody';
import { VizPanelBody } from '../canvas/panels/VizPanelBody';

...
const KEY_LEGEND: [string, string][] = [
  ['1', 'expand the head of the queue — the oldest discovery (always correct)'],
  ['2–9', 'pick a later frontier cell — a mistake: BFS is FIFO'],
  ['↵', 'also expands the head (same as 1)'],
  ['r', 'restart the level'],
];

export function IntroCard() {
  const { level, showIntro, complete, dismissIntro } = useFloodGame();

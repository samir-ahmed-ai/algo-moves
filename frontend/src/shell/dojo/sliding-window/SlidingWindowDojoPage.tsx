...
import { WindowGameProvider, useWindowGame } from './WindowGameProvider';
import { WindowBoard } from './ui/WindowBoard';
...
function StatusBar() {
  const { level, actions, message, error } = useWindowGame();
...
function SlidingWindowDojoPageBody() {
  const { completedCount } = useWindowGame();
  useGameKeyboard();

...
import { BisectGameProvider, useBisectGame } from './BisectGameProvider';
import { BisectBoard } from './ui/BisectBoard';
...
function StatusBar() {
  const { level, actions, message, error } = useBisectGame();
...
function BinarySearchDojoPageBody() {
  const { completedCount } = useBisectGame();
  useGameKeyboard();

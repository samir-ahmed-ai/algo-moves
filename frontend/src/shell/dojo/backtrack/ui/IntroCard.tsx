...
const KEY_LEGEND: [string, string][] = [
  ['h / l', 'move the cursor along the open row'],
  ['↵', 'place a queen on the cursor square'],
  ['u', 'backtrack — remove your last queen'],
  ['r', 'restart the level'],
  ['?', 'toggle safe-square hints'],
];

export function IntroCard() {
  const { level, showIntro, complete, dismissIntro } = useBacktrackGame();

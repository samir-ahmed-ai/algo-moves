...
export const ar: ArcadeStrings = {
  ...
  lobby: {
    ...
    lanHint:
      'وضع الشبكة المحلية: شغّل make backend-dev وافتح الموقع على عنوان IP جهازك. للعب عبر الإنترنت، عيّن VITE_API_SERVER_URL عند البناء.',
    yourRoom: 'غرفتك',
  ...
  partnerLeftBanner: {
    title: 'غادر شريكك.',
    detailHost:
      'تبقى اللعبة على الشاشة أثناء الانتظار. شارك رمز الغرفة مجدداً، أو اضغط «الألعاب» أعلاه لاختيار لعبة أخرى.',
    detailGuest:
  ...
  picker: {
    ...
    filterCouple: '💕 لاثنين',
    filterParty: '🎉 حفلة',
    categoryCouple: '♥ لاثنين',
    categoryParty: '🎉 حفلة',
    howToPlay: 'طريقة اللعب:',
    showHowToPlay: 'عرض طريقة اللعب',
    hideHowToPlay: 'إخفاء طريقة اللعب',
    needsPlayers: (min, max) => `يلزم ${min}–${max} لاعبين`,
    playerRange: (min, max) => `${min}–${max} ل`,
    defaultHowToPlay: 'لاعبان، فائز واحد. حظاً موفقاً!',
  },
  shareRoom: {
    roomCode: 'رمز الغرفة',

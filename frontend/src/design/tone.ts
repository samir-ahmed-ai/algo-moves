...
export const UI_TONES = ['default', 'accent', 'good', 'warn', 'bad', 'muted'] as const;
...
export const TONE_TEXT: Readonly<Record<UiTone, string>> = {
  ...
  warn: 'tone-text tone-text--warn text-warn',
...
export const TONE_CHIP: Readonly<Record<UiTone, string>> = {
  ...
  warn: 'tone-chip tone-chip--warn bg-warnbg text-warn',
...
export const TONE_BANNER: Readonly<Record<UiTone, string>> = {
  ...
  warn: 'tone-banner tone-banner--warn bg-warnbg/70 text-ink2',
...
export const TONE_LABEL: Readonly<Record<UiTone, string>> = {
  ...
  warn: 'tone-label tone-label--warn text-warn',

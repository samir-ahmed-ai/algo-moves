...
export const goodCases: WorkedCase<HeapInput>[] = [
  {
    ...
    input: {
      ops: [{ kind: 'insert', value: 3 }, { kind: 'insert', value: 1 }, { kind: 'extract' }],
    },
    ...
    answer:
      '1 bubbles up to the root via sift-up comparisons with parent — extract-min returns the root and sift-down restores the heap.',
  },
];

export const intro =
  'Binary heap in an array: parent at (i-1)/2, children at 2i+1 and 2i+2; sift-up on insert, sift-down on extract.';

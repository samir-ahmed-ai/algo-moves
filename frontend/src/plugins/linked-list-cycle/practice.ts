...
export const quiz: QuizQuestion[] = [
  {
    ...
    explain:
      'The distance from head to cycle entrance equals the distance from meeting point to entrance — reset one pointer to head and walk both at speed 1.',
  },
  {
    id: 'null',
    ...
    explain:
      'An acyclic linked list eventually runs off the end — the fast pointer reaches the end first.',
  },
];
...
export const codePieces: CodePiece[] = [
  ...
  {
    id: 'loop',
    code: '\tfor fast != nil && fast.Next != nil {',
    role: 'fast needs two hops — stop if acyclic',
  },
  {
    id: 'move',
    code: '\t\tslow = slow.Next\n\t\tfast = fast.Next.Next',
    role: '1 step vs 2 steps',
  },
  {
    id: 'meet',
    code: '\t\tif slow == fast {\n\t\t\treturn true\n\t\t}',

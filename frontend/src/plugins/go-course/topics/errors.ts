      ...
      "walkthrough": [
        {
          ...
          "caption": "lookup constructs a concrete *QueryError value, capturing the query id and code 42.",
          "focus": [
            "base := &QueryError{Query: id, Code: 42}"
          ],
          "state": [
        ...
        },
        {
          ...
          "caption": "fmt.Errorf with two %w verbs wraps both base and ErrNotFound into one error whose Unwrap returns a []error slice — a tree, not a linear chain.",
          "focus": [
            "fmt.Errorf(\"lookup %s: %w: %w\", id, base, ErrNotFound)"
          ],
          "state": [
            {
              "k": "return type",
        ...
        },
        {
          ...
          "caption": "The top error's Error() renders all three layers into one string as laid out by the format string.",
          "focus": [
            "fmt.Println(err)"
          ],
          "state": [
        ...
        },
        {
          ...
          "caption": "errors.Is traverses both branches (depth-first, preorder) and matches ErrNotFound by identity in the second child.",
          "focus": [
        ...
        },
        {
          ...
          "caption": "errors.As takes &qe (a **QueryError) and, walking the same tree, assigns the first *QueryError it finds into qe.",
          "focus": [
            "var qe *QueryError",
            "errors.As(err, &qe)"
          ],
        ...
        },
        {
          ...
          "caption": "Because As populated qe, its concrete fields Query and Code are now readable directly.",
          "focus": [
            "fmt.Printf(\"extracted: query=%s code=%d\\n\", qe.Query, qe.Code)"
          ],
          "state": [
        ...
        },
        {
          ...
          "caption": "Wrapping err again with a single %w adds a new root node above the existing tree, deepening but not flattening it.",
          "focus": [
        ...
        },
        {
          ...
          "caption": "errors.Is on the re-wrapped error descends through the new root into the tree and still finds ErrNotFound.",
          "focus": [
      ...
      "walkthrough": [
        {
          ...
          "caption": "A package-level sentinel error is created once at init and becomes part of the package's public API for identity comparison.",
          "focus": [
            "var ErrNotFound = errors.New(\"not found\")"
          ],
          "state": [
        ...
        },
        {
          ...
          "caption": "QueryError is a struct carrying structured context (Query, Code) plus a wrapped cause, so callers can extract fields instead of just comparing identity.",
          "focus": [
            "type QueryError struct {",
            "Err   error"
          ],
        ...
        },
        {
          ...
          "caption": "lookup returns a *QueryError whose Err field wraps ErrNotFound, building a two-link chain: QueryError -> ErrNotFound.",
          "focus": [
            "return &QueryError{Query: q, Code: 42, Err: ErrNotFound}"
          ],
          "state": [
        ...
        },
        {
          ...
          "caption": "errors.Is compares err to ErrNotFound, then follows Unwrap: QueryError isn't ErrNotFound, but Unwrap yields ErrNotFound which matches by identity, so it returns true.",
          "focus": [
            "errors.Is(err, ErrNotFound)",
            "func (e *QueryError) Unwrap() error { return e.Err }"
          ],
        ...
        },
        {
          ...
          "caption": "errors.As finds the first *QueryError in the chain and assigns it to qe, giving typed access to the structured Query and Code fields.",
          "focus": [
            "if errors.As(err, &qe) {",
            "fmt.Printf(\"extracted: query=%s code=%d\\n\", qe.Query, qe.Code)"
          ],
        ...
        },
        {
          ...
          "caption": "A fresh QueryError is built with the same Code 42 but a different wrapped cause, to test the custom equivalence rule.",
          "focus": [
            "probe := &QueryError{Code: 42, Err: errors.New(\"other\")}"
          ],
          "state": [
        ...
        },
        {
          ...
          "caption": "Because *QueryError defines its own Is method, errors.Is calls err.Is(probe) which compares only Code (42 == 42) and returns true despite the differing causes.",
          "focus": [
            "func (e *QueryError) Is(target error) bool {",
            "return e.Code == t.Code",
            "errors.Is(err, probe)"
      ...
      "walkthrough": [
        {
          ...
          "caption": "main calls safeDivide with b==0; the named returns result and err are zero-initialized before the body runs.",
          "focus": [
            "q, err := safeDivide(4, 0)",
            "func safeDivide(a, b int) (result int, err error)"
          ],
        ...
        },
        {
          ...
          "caption": "The deferred anonymous function is pushed onto safeDivide's defer stack but does not run yet; it closes over result and err by reference.",
          "focus": [
            "defer func() {",
            "if r := recover(); r != nil {"
          ],
        ...
        },
        {
          ...
          "caption": "a / b divides by zero, which triggers a runtime panic that aborts the normal flow before the return statement executes.",
          "focus": [
            "result = a / b",
            "return result, nil"
          ],
        ...
        },
        {
          ...
          "caption": "As the frame unwinds, the deferred closure runs; recover() called directly in it returns the panic value, stopping the panic.",
          "focus": [
            "if r := recover(); r != nil {",
            "err = fmt.Errorf(\"recovered: %v\", r)"
          ],
        ...
        },
        {
          ...
          "caption": "Because err is a named return mutated inside the defer, safeDivide returns result=0 and the recovered error even though the return statement never ran normally.",
          "focus": [
            "q, err := safeDivide(4, 0)",
            "fmt.Println(q, err)"
          ],
        ...
        },
        {
          ...
          "caption": "deferArgTiming evaluates Println's argument i now (10) and stores it; the later reassignment to 20 cannot change what was already captured.",
          "focus": [
            "defer fmt.Println(\"deferred arg captured:\", i)",
            "i = 20"
          ],
          "state": [
            {
        ...
        },
        {
          ...
          "caption": "On return, the deferred Println runs using the captured 10, so it prints 10 while the inline Println already printed 20 — the classic defer-arg gotcha.",
          "focus": [
        ...
        },
        {
          ...
          "caption": "rethrow panics with errSentinel; its defer recovers, matches it via errors.Is, and assigns the named err so the function returns cleanly instead of re-panicking.",
          "focus": [
            "panic(errSentinel)",
            "if e, ok := r.(error); ok && errors.Is(e, errSentinel) {",
            "err = e // handled"
      ...
      "walkthrough": [
        {
          ...
          "caption": "NotFoundError implements Error() so *NotFoundError satisfies the error interface, wrapping an inner err field.",
          "focus": [
            "type NotFoundError struct {",
            "func (e *NotFoundError) Error() string {"
          ],
        ...
        },
        {
          ...
          "caption": "Unwrap() returns the inner err, letting errors.Is/As descend from a *NotFoundError into whatever it wraps.",
          "focus": [
            "func (e *NotFoundError) Unwrap() error { return e.err }"
          ],
          "state": [
        ...
        },
        {
          ...
          "caption": "lookup returns a *NotFoundError whose err is fmt.Errorf(\"query: %w\", ErrBackend), so %w records ErrBackend as the wrapped target.",
          "focus": [
            "return &NotFoundError{Key: key, err: fmt.Errorf(\"query: %w\", ErrBackend)}"
          ],
          "state": [
        ...
        },
        {
          ...
          "caption": "errors.Join returns a multi-error whose Unwrap() []error yields both err and the \"audit failed\" error, branching the graph into a tree rather than a single line.",
          "focus": [
            "joined := errors.Join(err, errors.New(\"audit failed\"))"
          ],
          "state": [
        ...
        },
        {
          ...
          "caption": "errors.As traverses both join branches, matches the first branch's *NotFoundError, assigns it into nfe, and returns true.",
          "focus": [
            "errors.As(joined, &nfe)"
          ],
          "state": [
            {
              "k": "As result",
        ...
        },
        {
          ...
          "caption": "errors.Is walks into the *NotFoundError branch, follows Unwrap through the %w wrapError, and finds the sentinel ErrBackend by identity.",
          "focus": [
            "errors.Is(joined, ErrBackend)"
          ],
          "state": [
            {
              "k": "Is result",
        ...
        },
        {
          ...
          "caption": "Because As populated nfe with the concrete pointer, nfe is non-nil and its Key field is readable directly.",
          "focus": [
            "if nfe != nil {",
            "fmt.Println(\"Recovered key:\", nfe.Key)"
          ],

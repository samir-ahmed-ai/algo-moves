...
export const bundle: PracticeBundle = {
  "quiz": [
    ...
    },
    {
      ...
      "explain": "`close < open` ensures the string prefix always has a non-negative balance. `close < n` alone would allow illegal sequences like `))((`. The constraint `open < n` governs `(`."
    },
    {
      "id": "base-case",

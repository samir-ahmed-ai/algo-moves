...
export const bundle: PracticeBundle = {
  "quiz": [
    ...
    },
    {
      ...
      "explain": "The `memo` map stores one entry per vertex (O(V)), and the recursion depth is at most V in the worst case. Edge storage belongs to the output graph, not to the algorithm's auxiliary space."
    },
    {
      "id": "neighbor-order",

...
function record({ n }: FactorialInput): Frame<FactorialState>[] {
...
const practiceQuiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    explain:
      'Factorial number: compute n! = 1·2·3·…·n iteratively. Start an accumulator result = 1, then fold each factor from 2 up to  into it. Time O(n), Space O(1).',
  },
  {
    id: 'key-step',
    ...
    explain:
      'Multiply factor  into the accumulator: result =  ×  = . This folds  into the running product 1·2·…·.',
  },
  {
    id: 'state',

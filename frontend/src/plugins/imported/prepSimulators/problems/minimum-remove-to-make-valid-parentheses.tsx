...
const practiceQuiz: QuizQuestion[] = [
  ...
  {
    id: "init",
    prompt: "At the start of a run (Minimum Remove to Make Valid Parentheses), what strategy is established?",
    choices: [
      {
    ...
    explain: "Minimum Remove to Make Valid Parentheses: delete the fewest brackets so every \"(\" has a matching \")\". Scan left to right, pushing the index of each unmatched \"(\" onto a stack; a \")\" cancels the newest one, and anything that never matches gets removed."
  },
  {
    id: "key-step",
    ...
    explain: "Char  is \")\" but the stack is empty — there is no open bracket to match it. Mark index  for removal (shown as *)."
  },
  {
    id: "state",
    ...
    explain: "The recorder keeps `chars` in sync: current buffer, chars marked for removal show as '*'"
  },
  {
    id: "complexity",
    prompt: "What are the time and space complexities for \"Minimum Remove to Make Valid Parentheses\"?",
    choices: [
      {
  ...
  },
  {
    ...
    explain: "Strip every char marked \"*\". The remaining string \"\" is valid and we removed the minimum number of brackets ()."
  }
];

...
const practiceQuiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    explain:
      'l =  points at "" and r =  points at "". Since l < r, exchange these two words so the ends move toward the middle.',
  },
  {
    id: 'state',
  ...
  },
  {
    ...
    explain:
      'The pointers crossed, so the list is fully reversed. Join the words with single spaces to get the answer: "".',
  },
];

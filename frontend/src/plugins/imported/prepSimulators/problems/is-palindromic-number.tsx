...
const practiceQuiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    explain:
      'Is  a palindrome? We reverse only the back half of the number: build rev by peeling the last digit of n each step, and stop once rev catches up to n. That is O(log n) time and O(1) space — no string conversion.',
  },
  {
    id: 'key-step',
    ...
    explain:
      'Peel the last digit  off n and push it onto rev: rev = rev·10 +  = , then drop it from n so n = . Loop continues while n () > rev ().',
  },
  {
    id: 'state',

...
const practiceQuiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    explain:
      'Diagonal Traverse: walk the × matrix along its anti-diagonals in a zig-zag. Start at (0,0) heading . Each diagonal is read in alternating direction. Time O(m·n), O(1) extra.',
  },
  {
    id: 'key-step',
...
export const simulator: ProblemSimulator = {
  ...
  verdict: (frames) => {
    ...
    return s ? { ok: true, label: `[${s.res.join(',')}]` } : { ok: false, label: 'no result' };
  },
};

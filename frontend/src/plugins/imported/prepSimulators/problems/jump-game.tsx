...
const practiceQuiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    explain: "Jump Game: each value nums[i] is the max jump length from index i. Greedily track reach — the farthest index we can get to. Start at index 0 with reach = 0, and only ever step onto indices we can already reach."
  },
  {
    id: "key-step",
    ...
    explain: " is farther than the old reach , so we stretch reach to . We can now get to every index up through ."
  },
  {
    id: "state",
  ...
  },
  {
    ...
    explain: " does not beat the current reach , so reach is unchanged. Move to the next reachable index."
  }
];

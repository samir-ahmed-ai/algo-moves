...
const practiceQuiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    explain: "Count(,): scan diagonal partners p where |px-qx|=|py-qy| and px≠qx. Sum cnt[px,qy]×cnt[qx,py] = ."
  },
  {
    id: "state",
    ...
    explain: "The recorder snapshots `points` on every emit so each frame shows the algorithm mid-step."
  },
  {
    id: "outcome",

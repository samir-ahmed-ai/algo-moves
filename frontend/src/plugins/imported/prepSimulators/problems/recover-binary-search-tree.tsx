...
const practiceQuiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    explain: "Second inversion:  > . The swapped nodes were not adjacent in-order, so update second to this node (). Keep first as it was."
  },
  {
    id: "state",
  ...
  },
  {
    ...
    explain: "O(n). O(h). In-order traversal of a valid BST is sorted. Two swapped nodes create inversions.; Track `prev`: if `prev.Val > node.Val`, found an inversion. First inversion: "
  },
  {
    id: "outcome",
    ...
    explain: "Walk complete. The two misplaced nodes hold  and . Exchanging their values restores the BST."
  }
];

...
const practiceQuiz: QuizQuestion[] = [
  ...
  {
    id: "init",
    prompt: "At the start of a run (Amount of New Area Painted Each Day), what strategy is established?",
    choices: [
      {
    ...
    explain: "Amount of New Area Painted Each Day: jump[] skips already-painted segments. For each [l,r), walk with jump pointers — count only cells where jump[i]==0 (fresh paint)."
  },
  {
    id: "key-step",
    ...
    explain: "Day : paint [, ). Jump-pointer walk finds  newly painted cell(s). Overlaps skip via jump[i]=r."
  },
  {
    id: "state",
    ...
    explain: "The recorder snapshots `maxR` on every emit so each frame shows the algorithm mid-step."
  },
  {
    id: "complexity",

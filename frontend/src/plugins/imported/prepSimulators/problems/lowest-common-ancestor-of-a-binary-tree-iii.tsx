...
const practiceQuiz: QuizQuestion[] = [
  ...
  },
  {
    id: 'init',
    prompt:
      'At the start of a run (Lowest Common Ancestor of a Binary Tree III), what strategy is established?',
    choices: [
      {
    ...
    explain:
      "LCA III uses only parent pointers (no root). Same trick as intersecting two linked lists: pointer a starts at p (), pointer b starts at q (). Each walks up to its parent; when one falls off the top it restarts at the other's start, so both travel the same total distance and meet at the LCA.",
  },
  {
    id: 'key-step',
  ...
  },
  {
    id: 'complexity',
    prompt:
      'What are the time and space complexities for "Lowest Common Ancestor of a Binary Tree III"?',
    choices: [
      {
    ...
    explain:
      'O(h). O(1). Same trick as "intersection of two linked lists": two pointers `a` and `b` start at `p` and `q`; When one reaches `nil`, redirect it to the other\'s start',
  },
  {
    id: 'outcome',

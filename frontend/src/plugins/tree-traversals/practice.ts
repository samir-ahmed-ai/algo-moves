...
export const codePieces: CodePiece[] = [
  {
    id: 'node',
    code: 'type Node struct{ Val int; Left, Right *Node }',
    role: 'node type — value plus left/right child pointers',
  },
  {
    id: 'inorder-sig',
    code: 'func inorder(n *Node, out *[]int) {',
    role: 'in-order DFS: append values to out via pointer',
  },
  {
    id: 'inorder-base',
    code: '\tif n == nil {\n\t\treturn\n\t}',
  ...
  {
    id: 'inorder-node',
    code: '\t*out = append(*out, n.Val)',
    role: 'visit the node BETWEEN its subtrees → sorted for a BST',
  },
  {
    id: 'inorder-right',
    code: '\tinorder(n.Right, out)\n}',
    role: 'then recurse the RIGHT subtree',
  },
  {
    id: 'level-sig',
    code: 'func levelOrder(root *Node) []int {',
    role: 'level-order BFS entry point',
  },
  {
    id: 'level-init',
    code: '\tout := []int{}\n\tif root == nil {\n\t\treturn out\n\t}',
  ...
  { id: 'level-queue', code: '\tq := []*Node{root}', role: 'seed the FIFO queue with the root' },
  {
    ...
    role: 'dequeue the front node and emit its value',
  },
  {
    id: 'level-children',
    code: '\t\tif n.Left != nil {\n\t\t\tq = append(q, n.Left)\n\t\t}\n\t\tif n.Right != nil {\n\t\t\tq = append(q, n.Right)\n\t\t}\n\t}',

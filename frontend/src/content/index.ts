...
import { IMPORTED_COURSES, PREP_COURSES, GO_COURSES, OPENRTB_COURSES } from '@/plugins/_generated/courses';
...
export { PROBLEM_BRIEFS, briefFor, type ProblemBrief, type ProblemBriefCase } from './problemBriefs';

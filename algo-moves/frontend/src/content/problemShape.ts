...
export const SHAPE_GLYPHS: Record<ShapeKey, string> = {
  ...
  tree:
    '<circle cx="24" cy="9" r="3.2" fill="var(--accent)" stroke="none"/><circle cx="13" cy="25" r="3.2"/><circle cx="35" cy="25" r="3.2"/><circle cx="8" cy="40" r="3"/><circle cx="19" cy="40" r="3"/><circle cx="35" cy="40" r="3"/><path d="M21.6 11.4 15.4 22.6M26.4 11.4 32.6 22.6M11.2 27.8 9.2 37.2M14.8 27.8 17.6 37.2M35 28.2v9"/>',
  grid:
    '<rect x="8" y="8" width="32" height="32" rx="2"/><path d="M18.7 8v32M29.3 8v32M8 18.7h32M8 29.3h32"/><rect x="18.7" y="18.7" width="10.6" height="10.6" fill="var(--accent)" fill-opacity="0.85" stroke="none"/>',
  linkedList:
  ...
  heap:
    '<circle cx="24" cy="10" r="3.2" fill="var(--accent)" stroke="none"/><circle cx="14" cy="25" r="3.2"/><circle cx="34" cy="25" r="3.2"/><circle cx="9" cy="39" r="3"/><circle cx="19" cy="39" r="3"/><circle cx="29" cy="39" r="3"/><path d="M21.8 12.4 16.2 22.6M26.2 12.4 31.8 22.6M12.2 27.6 10.4 36.4M15.8 27.6 17.6 36.4M32 27.6 30.2 36.4"/>',
  dp:
    '<rect x="7" y="9" width="34" height="30" rx="2"/><path d="M7 19h34M7 29h34M17 9v30M27 9v30"/><rect x="7" y="9" width="10" height="10" fill="var(--good)" fill-opacity="0.8" stroke="none"/><rect x="17" y="9" width="10" height="10" fill="var(--good)" fill-opacity="0.4" stroke="none"/><rect x="7" y="19" width="10" height="10" fill="var(--good)" fill-opacity="0.4" stroke="none"/><rect x="17" y="19" width="10" height="10" fill="var(--accent)" stroke="none"/>',
  binarySearch:
...
export function shapeFor(item: Item): ShapeKey {
  ...
  if (
    ...
    return 'graph';
  if (has('two-pointers') || has('sliding-window') || has('sorting') || has('intervals') || has('array') || has('string'))
    return 'array';

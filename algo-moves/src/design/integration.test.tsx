...
import { STRUDEL_NODE_W } from '../shell/canvas/nodeTokens';
import { vizMinWidth, vizWireGap } from '../shell/canvas/canvasTokens';
import { LAYOUT_PRESET_META } from '../shell/canvas/layout';

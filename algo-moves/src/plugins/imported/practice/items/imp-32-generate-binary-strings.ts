  ...
  "quiz": [
    {
      ...
      "choices": [
        {
          "label": "Backtracking enumeration via DFS",
          "correct": true
        },
        {
          "label": "BFS level-order generation"
        },
        {
          "label": "Dynamic programming with memoization"
        },
        {
          "label": "Greedy bit-by-bit selection"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        ...
        {
          "label": "When both recursive calls have returned, collect results"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "It makes two recursive calls at every level — one appending '0', one appending '1' — so the tree has 2^n leaves",
          "correct": true
        },
        {
        ...
        {
          "label": "It uses a bitmask to enumerate all n-bit integers"
        },
        {
          "label": "It calls itself n times sequentially, doubling a list each time"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "Go strings are immutable, so each concatenation creates a new independent value — no undo step is needed",
          "correct": true
        },
        {
        ...
        {
          "label": "The compiler requires immutable arguments for recursive functions"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "An empty slice with no elements"
        },
        {

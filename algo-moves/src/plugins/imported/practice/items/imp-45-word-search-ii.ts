...
export const bundle: PracticeBundle = {
  "quiz": [
    ...
    {
      "id": "trie-build",
      "prompt": "During trie construction, the word string is stored at `cur.word` after iterating all characters. What does the code check to know a complete word ends at a given node?",
      "choices": [
        {

  ...
  "quiz": [
    {
      ...
      "choices": [
        {
          "label": "Quickselect with Lomuto-style partition",
          "correct": true
        },
        {
        ...
        {
          "label": "Merge sort with early termination"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "The kth largest is the (n+1-k)th smallest, so we reuse the same smallest-order selection logic",
          "correct": true
        },
        {
          "label": "To offset for 0-based indexing"
        },
        {
          "label": "To handle the case where k equals n"
        },
        {
          "label": "Because `btPartition` counts from the right"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "All elements at indices < pos are < pivot, the pivot sits at pos, and all elements at indices > pos are >= pivot",
          "correct": true
        },
        {
        ...
        {
          "label": "pos holds the median of the subarray"
        },
        {
          "label": "Elements to the right of pos are sorted in descending order"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "`start == end`: only one element remains, so it must be the kth element",
          "correct": true
        },
        {
        ...
        {
          "label": "`k == 1`: return the minimum of the subarray"
        },
        {
          "label": "`start == 0 && end == n-1`: the full array has been searched"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "O(n) average, O(n²) worst case",
          "correct": true
        },
        {
        ...
        {
          "label": "O(log n) average"
        },
        {
          "label": "O(n) always, including worst case"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "`btPartition` swaps elements in place, so copying prevents mutating the caller's array",
          "correct": true
        },
        {
          "label": "Go slices are not passed by reference, so a copy is needed to share data"
        },
        {
          "label": "To allow parallel execution of the two functions"
        },
        {
          "label": "`btQuickSelect` requires a zero-indexed slice starting at a fresh backing array"
        }
      ],

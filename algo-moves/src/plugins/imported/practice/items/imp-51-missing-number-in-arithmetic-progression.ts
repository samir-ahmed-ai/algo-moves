  ...
  "quiz": [
    {
      ...
      "choices": [
        ...
        {
          "label": "Prefix-sum difference scan"
        },
        {
          "label": "Two-pointer arithmetic"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "The slice holds n present terms but, with one interior term removed from the full progression, a[0]..a[n-1] still spans n steps of the common difference",
          "correct": true
        },
        {
          "label": "To avoid a divide-by-zero when the array has one element"
        },
        {
          "label": "Because `a` is 0-indexed"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "The left half [low, mid] is intact, so the missing term must be in the right half",
          "correct": true
        },
        {
          "label": "The missing term has been found at `mid`"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "The loop exits with `low > high`; `low` is the first index where the actual value diverges from the expected AP value, which is exactly the position of the missing term",
          "correct": true
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "The missing term must be interior — if the first or last term were missing, a[high]-a[low] would no longer span the full n steps and `diff` would be wrong",
          "correct": true
        },
        {
        ...
        {
          "label": "It returns 0 whenever the missing term is at an endpoint"
        }
      ],

  ...
  "quiz": [
    {
      ...
      "choices": [
        ...
        {
          "label": "Dynamic programming on row/column prefix counts"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        ...
        {
          "label": "It stores visited coordinates in a hash set"
        },
        {
          "label": "It decrements a counter for each visited cell"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "Bounds (r<0, r>=m, c<0, c>=n) then content (grid[r][c]!='1'); bounds must come first to avoid index panic",
          "correct": true
        },
        {
          "label": "Content first (grid[r][c]!='1') then bounds; content is cheaper to check"
        },
        {
          "label": "Only bounds; content is guaranteed '1' by the caller"
        },
        {
          "label": "Only content; the grid is padded with sentinel '0' rows/columns"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        ...
        {
          "label": "8-directional: including all 4 diagonals"
        },
        {
          "label": "2-directional: only right and down"
        },
        {
          "label": "1-directional: only downward (row+1)"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "Time O(m·n), Space O(m·n) — each cell is visited at most once; recursion stack is O(m·n) in the worst case",
          "correct": true
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "`numIslands` returns 0 — no '1' cell is ever found, so `cnt` stays 0 and `btFloodFill` is never called",
          "correct": true
        },
        {
        ...
        {
          "label": "It panics because `btFloodFill` dereferences an empty grid"
        },
        {
          "label": "It returns 1, counting the entire water area as one region"
        }
      ],

...
export const bundle: PracticeBundle = {
  "quiz": [
    ...
    },
    {
      ...
      "explain": "In the worst case (dest unreachable), BFS explores all V vertices and E edges: O(V+E). The early-return optimization only helps when dest is found before full exploration."
    }
  ]
};

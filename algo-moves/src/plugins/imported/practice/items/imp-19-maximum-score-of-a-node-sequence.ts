  ...
  "quiz": [
    {
      ...
      "choices": [
        {
          "label": "Greedy enumeration over edges with per-node top-3 neighbor lists",
          "correct": true
        },
        {
          "label": "BFS shortest path across the weighted graph"
        },
        {
          "label": "Dynamic programming over node subsets"
        },
        {
          "label": "Union-Find to merge high-score components"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "A sorted slice of up to 3 neighbor indices, ordered by descending score",
          "correct": true
        },
        {
        ...
        {
          "label": "A hash set of the 3 neighbors with the lowest scores"
        },
        {
          "label": "A linked list of all neighbors in insertion order"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        ...
        {
          "label": "Revisiting edges that were already processed"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "At most one of the top-3 neighbors of u can equal v, leaving at least two valid extension candidates",
          "correct": true
        },
        {
          "label": "The graph is guaranteed to have at most 3 edges per node"
        },
        {
          "label": "Keeping more neighbors would exceed the O(E) time bound"
        },
        {
          "label": "Scores are bounded such that the 4th neighbor can never beat the top-3 sum"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "O(E) — each edge is visited once; the inner neighbor loops are bounded by 9 (3×3) iterations",
          "correct": true
        },
        {
    ...
    },
    {
      ...
      "choices": [
        ...
        {
          "label": "It returns the score of the single highest-scoring edge"
        }
      ],

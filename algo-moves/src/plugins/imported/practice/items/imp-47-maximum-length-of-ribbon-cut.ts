  ...
  "quiz": [
    {
      ...
      "choices": [
        ...
        {
          "label": "Dynamic programming on ribbon lengths"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "The total number of pieces of length `mid` obtainable from all ribbons; if `cnt >= k` the length is feasible",
          "correct": true
        },
        {
          "label": "The remainder after cutting each ribbon to length `mid`"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "A single piece can be at most as long as the longest ribbon, so that caps the answer",
          "correct": true
        },
        {
          "label": "To avoid reading past the end of the slice"
        },
        {
          "label": "Because the binary search needs a power-of-two range"
        },
        {
          "label": "`len(ribbons)` could be zero, causing a divide-by-zero"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "To find the *maximum* feasible length — a larger `mid` might also yield enough pieces",
          "correct": true
        },
        {
          "label": "To verify there are no duplicate lengths"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "It is monotonic: larger `mid` yields fewer (or equal) pieces, so once it becomes infeasible it stays infeasible",
          "correct": true
        },
        {
        ...
        {
          "label": "It is strictly increasing in `mid`"
        },
        {

  ...
  "quiz": [
    {
      ...
      "choices": [
        {
          "label": "Top-down memoized DP with a base-3 bitmask state",
          "correct": true
        },
        {
        ...
        {
          "label": "Greedy assignment: always place the current number in the slot that maximizes its AND value"
        },
        {
          "label": "BFS over assignment states using a priority queue"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "Each slot can hold at most 2 numbers",
          "correct": true
        },
        {
        ...
        {
          "label": "The AND of two numbers placed in the same slot must be less than 2"
        },
        {
          "label": "The slot index must be a power of 2"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "Yes — `idx` is fully determined by the total number of assignments encoded in `state`, so `state` alone uniquely identifies the subproblem",
          "correct": true
        },
        {
          "label": "No — two different (idx, state) pairs can have the same state but different remaining nums, producing wrong results"
        },
        {
          "label": "Yes — but only because nums is sorted before the recursion begins"
        },
        {
          "label": "No — the memo should also include the current `res` value to avoid overwriting better solutions"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "O(n · 3^numSlots) time, O(3^numSlots) space",
          "correct": true
        },
        {
          "label": "O(n · 2^numSlots) time, O(2^numSlots) space"
        },
        {
          "label": "O(n · numSlots) time, O(n · numSlots) space"
        },
        {
          "label": "O(numSlots^n) time, O(numSlots^n) space"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "0, because there are no more numbers to assign",
          "correct": true
        },
        {
        ...
        {
          "label": "The value of the last slot processed"
        },
        {
          "label": "Negative infinity to signal an invalid assignment"
        }
      ],

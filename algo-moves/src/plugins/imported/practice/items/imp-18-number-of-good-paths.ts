  ...
  "quiz": [
    {
      ...
      "choices": [
        {
          "label": "Sort nodes by value in ascending order and use Union-Find to merge components, counting same-value nodes per component",
          "correct": true
        },
        {
        ...
        {
          "label": "DFS post-order enumeration of all root-to-leaf paths"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "It ensures we only merge along edges where the neighbour has already been processed (value ≤ current), keeping higher-value nodes in separate components until it is their turn",
          "correct": true
        },
        {
          "label": "It avoids creating cycles by preventing merges across same-value nodes"
        },
        {
          "label": "It implements union-by-rank, attaching lower-value roots under higher-value roots"
        },
        {
          "label": "It filters out edges that are not part of the tree's critical path"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "The number of unordered pairs of nodes in the same component that share the current value — i.e., good paths with that value as the maximum",
          "correct": true
        },
        {
        ...
        {
          "label": "The number of nodes in the component times their common value"
        },
        {
          "label": "The binomial coefficient for choosing 2 components to merge next"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "Each single node is a trivial good path from itself to itself, contributing n paths of length 0",
          "correct": true
        },
        {
        ...
        {
          "label": "The Union-Find initialisation creates n components each counted as one path"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "The root of the component with the higher value is chosen as the new root, not the larger component",
          "correct": true
        },
        {
          "label": "It is identical to union-by-size because higher-value components are always larger"
        },
        {
          "label": "It attaches the root with the lower value under the higher-value root, equivalent to union-by-rank"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "Sorting the n node ids by value; the Union-Find operations are nearly linear",
          "correct": true
        },
        {
          "label": "The nested loops over value groups and adjacency list edges, which total O(n²)"
        },
        {
          "label": "Path compression in `goodPathsFind` which requires O(log n) per call"
        },
        {
          "label": "Building the adjacency list from n-1 edges costs O(n log n)"
        }
      ],

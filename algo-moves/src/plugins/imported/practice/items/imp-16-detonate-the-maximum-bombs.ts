  ...
  "quiz": [
    {
      ...
      "choices": [
        {
          "label": "Build a directed graph of chain detonations, then DFS from each node and take the maximum reachable count",
          "correct": true
        },
        {
        ...
        {
          "label": "Union-Find to cluster mutually reachable bombs and return the largest cluster"
        },
        {
          "label": "Sort bombs by radius and greedily select the one with the most overlap"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "To avoid floating-point precision errors — squaring keeps all comparisons in integer arithmetic",
          "correct": true
        },
        {
          "label": "To make the check asymmetric so that edges are directed (i→j but not j→i)"
        },
        {
          "label": "Because `math.Sqrt` is not available in the `main` package without an import"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "The total number of bombs reachable (including the starting bomb) via the detonation chain",
          "correct": true
        },
        {
        ...
        {
          "label": "The number of unique paths from the starting bomb to any other bomb"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "Later starting bombs would skip nodes already visited from a previous start, underreporting their reachable count",
          "correct": true
        },
        {
          "label": "The vis slice would grow unbounded, causing an out-of-memory error"
        },
        {
          "label": "The DFS would revisit every edge, increasing time complexity to O(n⁴)"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "The answer could be wrong — a bomb j that cannot reach i would incorrectly contribute to i's chain count",
          "correct": true
        },
        {
          "label": "The answer would always be the same because detonation chains are symmetric in practice"
        },
        {
          "label": "The DFS would run faster because each edge is traversed in both directions"
        },
        {
          "label": "The space complexity would drop to O(n) since the adjacency list becomes smaller"
        }
      ],

  ...
  "quiz": [
    {
      ...
      "choices": [
        {
          "label": "BFS shortest path on an unweighted graph with path reconstruction",
          "correct": true
        },
        {
          "label": "Dijkstra's algorithm for weighted graphs"
        },
        {
          "label": "DFS backtracking to collect all paths"
        },
        {
          "label": "Bidirectional BFS for faster convergence"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "It records each node's parent in the BFS tree so the path can be traced backwards from dest to src",
          "correct": true
        },
        {
        ...
        {
          "label": "It holds the distance from src to each node"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        ...
        {
          "label": "When the queue becomes empty"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "It prepends each node (`path = append([]int{at}, path...)`) while walking pred from dest to src",
          "correct": true
        },
        {
          "label": "It appends each node and then reverses the slice"
        },
        {
          "label": "It appends each node while walking pred from src to dest"
        },
        {
          "label": "It uses a stack to reverse the predecessor chain"
        }
      ],

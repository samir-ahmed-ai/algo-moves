  ...
  "quiz": [
    {
      ...
      "choices": [
        {
          "label": "DFS backtracking with dictionary-driven prefix matching",
          "correct": true
        },
        {
        ...
        {
          "label": "Greedy left-to-right character assignment"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "A slice-out-of-bounds panic when a dictionary key is longer than the remaining string",
          "correct": true
        },
        {
        ...
        {
          "label": "Revisiting a position already consumed"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "The entire digit string has been consumed by dictionary keys; `path` holds a complete valid decoding",
          "correct": true
        },
        {
          "label": "All dictionary keys have been tried at least once"
        },
        {
          "label": "The remaining suffix is too short for any key to match"
        },
        {
          "label": "A mismatch was detected and the branch must be abandoned"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "The recursion tree has branching factor d at each of the s positions, giving d^s possible paths in the worst case",
          "correct": true
        },
        {
          "label": "There are s! orderings of d keys"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "Each key is matched using `s[idx:idx+len(key)]` and the index advances by `idx+len(key)`, not by a fixed 1",
          "correct": true
        },
        {
          "label": "Keys are padded to the same length before matching"
        },
        {
          "label": "The loop iterates character by character and accumulates key candidates"
        },
        {
          "label": "Only single-character keys can match; multi-character keys are ignored"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "The order is not deterministic — Go randomizes map iteration order, so results can appear in any order across runs",
          "correct": true
        },
        {
          "label": "Results are always sorted lexicographically by key"
        },
        {
          "label": "Results follow the insertion order of the dictionary"
        },
        {
          "label": "Results are ordered by the byte value of `ch`"
        }
      ],

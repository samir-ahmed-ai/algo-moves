  ...
  "quiz": [
    {
      ...
      "choices": [
        {
          "label": "2D table of size (m+1) × (n+1) where m and n are string lengths",
          "correct": true
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "The LCS length of the prefixes text1[:i-1] and text2[:j-1]",
          "correct": true
        },
        {
          "label": "The LCS length of the prefixes text1[:i] and text2[:j]"
        },
        {
          "label": "The length of the longest match ending at the previous character of text1"
        },
        {
          "label": "The minimum edits needed to align text1[:i] and text2[:j]"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "Skipping the current char of text1, or skipping the current char of text2 — take the better option",
          "correct": true
        },
        {
        ...
        {
          "label": "The LCS of the two strings reversed, used for palindrome detection"
        },
        {
          "label": "The edit distance contributions from deletions vs insertions"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "Time O(m*n), Space O(m*n)",
          "correct": true
        },
        {
          "label": "Time O(m*n), Space O(min(m,n))"
        },
        {
          "label": "Time O(m+n), Space O(m*n)"
        },
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "Go zero-initializes slices, and LCS of any string with an empty string is 0",
          "correct": true
        },
        {
          "label": "The loops start at i=1 and j=1, so row 0 and col 0 are never written or read"
        },
        {
          "label": "The max() calls propagate zeros from the boundaries automatically"
        },
        {
          "label": "The +1 offset means row 0 corresponds to an impossible state that never matters"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "dp[i][j] represents prefixes of length i and j, so character index i-1 is the last char of that prefix",
          "correct": true
        },
        {
        ...
        {
          "label": "It avoids reading past the end of the string when i equals m"
        },
        {
          "label": "The loop bounds include an off-by-one that the -1 compensates for"
        }
      ],

  ...
  "quiz": [
    {
      ...
      "choices": [
        ...
        {
          "label": "Find the rightmost element less than or equal to `key`"
        },
        {
          "label": "Find an exact match or return -1"
        },
        {
          "label": "Find the element closest to `key` in absolute value"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "No element in `a` is strictly greater than `key`",
          "correct": true
        },
        {
        ...
        {
          "label": "Binary search didn't converge"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "To search the left half for a potentially smaller element that is still greater than `key`",
          "correct": true
        },
        {
        ...
        {
          "label": "To handle the case where `a[mid]` equals `key + 1`"
        },
        {
          "label": "To advance towards larger values"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "The caller receives the value, not the index, of the smallest element greater than `key`",
          "correct": true
        },
        {
        ...
        {
          "label": "It returns the distance from `key` to the found element"
        }
      ],

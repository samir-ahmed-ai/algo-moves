  ...
  "quiz": [
    {
      ...
      "choices": [
        ...
        {
          "label": "Backtracking with memoization over character indices"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "An empty target t can always be formed from any prefix of s in exactly one way (choose nothing)",
          "correct": true
        },
        {
          "label": "It prevents divide-by-zero when computing the recurrence"
        },
        {
          "label": "It represents the case where s is empty and t is non-empty"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "Skip s[i-1]: all ways to form t[:j] from s[:i-1] are still valid without using s[i-1]",
          "correct": true
        },
        {
          "label": "Delete t[j-1] and inherit the count from the previous row"
        },
        {
          "label": "Copy the value from the previous column to avoid recomputation"
        },
        {
    ...
    },
    {
      ...
      "choices": [
        {
          "label": "It counts the ways we can use s[i-1] to match t[j-1], combined with all ways s[:i-1] already matched t[:j-1]",
          "correct": true
        },
        {
        ...
        {
          "label": "It counts permutations instead of combinations"
        },
        {
          "label": "It handles overlapping characters by subtracting duplicates"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        ...
        {
          "label": "O(m·n·log n) time, O(m·n) space"
        }
      ],
    ...
    },
    {
      ...
      "choices": [
        ...
        {
          "label": "It is undefined and never accessed"
        }
      ],

...
export const quiz: QuizQuestion[] = [
  {
    ...
    choices: [
      { label: 'Move left past the previous occurrence of that character', correct: true },
      { label: 'Move right back one step' },
      { label: 'Clear the entire window' },
      { label: 'Ignore the duplicate' },
    ],

...
export const PROBLEM_GISTS: Record<string, string> = {
  ...
  'imp-28-combination-of-subset-strings': 'Build every length-k string from the allowed characters.',
  ...
  'imp-31-expression-add-operators': 'Insert +, −, and × between digits so the expression equals the target.',
  'imp-32-generate-binary-strings': 'List every binary string of a given length.',
  'imp-33-strobogrammatic-number-ii': 'Find every number of length n that reads the same upside down.',
  'imp-34-generate-parentheses': 'List every way to arrange n pairs of parentheses that stay balanced.',
  'imp-36-letter-combinations-of-a-phone-number': 'List every word those phone-keypad digits could spell.',
  'imp-37-maximum-length-of-a-concatenated-string-with-uni': 'Concatenate chosen strings into the longest one with no repeated letter.',
  'imp-38-nested-list-weight-sum': 'Sum each integer in the nested list, weighted by how deep it sits.',
  'imp-39-different-ways-to-add-parentheses': 'Compute every result you can get by parenthesizing the expression differently.',
  ...
  'imp-42-cartesian-product-of-multiple-arrays': 'List every combination that picks one item from each array.',
  'imp-43-permutations': 'List every ordering of the characters in the string.',
  'imp-0-06-print-all-paths-from-source-to-destination': 'List every path from the source node to the destination.',
  ...
  'imp-7-is-graph-bipartite': "Decide whether the graph's nodes split into two conflict-free groups.",
  ...
  'imp-0-03-find-shortest-path-with-bfs': 'Find the shortest path between two nodes in an unweighted graph.',
  'imp-0-04-graph-traversal': 'Visit every node reachable from the start.',
  'imp-0-05-has-path-from-source-to-destination': 'Decide whether a path exists from the source node to the destination.',
  'imp-0-08-topological-sort-with-dfs': 'Order the nodes so every edge points from an earlier node to a later one.',
  ...
  'imp-3-remove-invalid-parentheses': 'Remove the fewest parentheses to make the string valid, every way.',
  ...
  'imp-14-the-earliest-moment-when-everyone-become-friends': 'Find the earliest time every person is connected as friends.',
  'imp-15-find-all-possible-recipes-from-given-supplies': 'Find which recipes you can make from your starting supplies.',
  'imp-16-detonate-the-maximum-bombs': 'Pick one bomb to trigger the largest chain reaction of blasts.',
  'imp-17-maximal-network-rank': 'Find the two cities with the most roads touching them combined.',
  'imp-18-number-of-good-paths': 'Count paths whose two endpoints are the largest value along the way.',
  'imp-19-maximum-score-of-a-node-sequence': 'Find the highest-scoring sequence of four connected nodes.',
  ...
  'imp-25-critical-connections-in-a-network': 'Find the edges whose removal would split the network apart.',
  // Binary search
  'binary-search': 'Find the position of a target value in a sorted array.',
  'imp-46-search-in-rotated-sorted-array': "Find a target's index in a sorted array that has been rotated.",
  'imp-47-maximum-length-of-ribbon-cut': 'Find the longest piece length that still yields at least k pieces.',
  'imp-48-find-smallest-letter-greater-than-target': 'Find the smallest letter in the sorted list larger than the target.',
  'imp-49-kth-largest-element-in-an-array': 'Find the kth largest value in the array.',
  'imp-50-find-right-interval': 'For each interval, find the nearest one starting at or after its end.',
  'imp-51-missing-number-in-arithmetic-progression': 'Find the one missing term in an evenly-spaced sequence.',
  'imp-52-missing-number': 'Find the missing value from a run of consecutive numbers.',
  'imp-53-find-first-and-last-position-of-element-in-sorte': 'Find the first and last index of a target in a sorted array.',
  ...
  'imp-62-filling-bookcase-shelves': 'Place the books in order on shelves to minimize the total height.',
  ...
  'imp-79-partition-array-into-two-arrays-to-minimize-sum-': 'Split the numbers into two equal halves with the smallest sum gap.',

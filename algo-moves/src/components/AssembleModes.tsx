...
import { Btn, Chip, EmptyState, Label, Meter, MiniTabs, nodeText } from '../shell/canvas/nodeui';
import { useCodeStudio } from '../shell/canvas/CodeStudio';
...
type BlockKind = 'def' | 'loop' | 'branch' | 'return' | 'close' | 'stmt';

const BLOCK_META: Record<BlockKind, { label: string; shape: string; icon: LucideIcon; bg: string; stroke: string; text: string }> = {
...
function blockKind(piece: CodePiece): BlockKind {
